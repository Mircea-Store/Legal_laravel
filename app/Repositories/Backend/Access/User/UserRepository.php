...
class UserRepository extends BaseRepository
{
    ...
    public function create($request)
    {
        ...
        DB::transaction(function () use ($user, $data, $roles, $permissions, $request) {
            if ($user->save()) {
    ...
    protected function createUserStub($input)
    {
        ...
        $user->plan = isset($input['plan']) ? $input['plan'] : null;
        $user->created_by = access()->user()->id;
        // $user->url_slug = UrlSlug($input['first_name'].' '.$input['last_name'],'users','url_slug');
        return $user;
    }
