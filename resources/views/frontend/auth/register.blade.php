        ...
        <div class="row">
          ...
          <div class="alert alert-danger error-msg" style="display:none;"></div>
            ...
            <div class="shadow_box">
                ...
                <div class="form-group">
                  {{ Form::input('mobile', 'mobile', null, ['class' => 'form-control', 'placeholder' => trans('validation.attributes.frontend.register-user.mobile')]) }}
                ...
                <div class="form-group {{$errors->first('is_term_accept')?'has-error':''}}">
                  <label class="col-md-12 control-label text-left">
                    ...
                    I accept <label  style="color:red; cursor: pointer;" id="myBtn" onclick="myBtn()">terms and conditions</label>
