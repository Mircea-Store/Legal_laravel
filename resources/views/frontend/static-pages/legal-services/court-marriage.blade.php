...
@section('meta_description', 'Lawyer for Court Marriage in India from kanoonvala.com Get Court Marriage Advice from highly experienced lawyers of www.kanoonvala.')
                  ...
                  <div class="col-md-8 col-md-offset-2">
                    <div class="row">
                      <div class="col-md-12 anima">
                        <h1 class="text-white text-l heading_one">Court Marriage Online Registration In India</h1>
                      </div>
                    </div>
                  </div>
                </div>
