...
<!-- Dynamic Tiltile  --> 
@section('title', 'Manage all type of Working Capital Loan at kanoonvala.com') 
@section('meta_description', 'We are manging all type of Working Capital Loan.')
@section('meta_keywords', 'Working Capital Loan, personal loan, company financial accounting ')
