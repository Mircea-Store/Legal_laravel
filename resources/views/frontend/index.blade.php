...
@section('content')
            ...
            <div class="flexslider advanced-slider slider visible-dir-nav" data-options="animation:fade">
                <ul class="slides">
                                    ...
                                    <div class="container-inner text-center">
                                        <div class="row">
                                            <div class="col-md-12 anima">
                                                <h2 class="text-white">Get Legal Advices From Top Lawyers
                                                    <span>Of India</span></h2>
                                            </div>
                                            <div  class="col-md-3 col-md-offset-9" 
                                            style="border:4px solid white; cursor: pointer; font-size: 30px;
                                            padding: 10px;" onclick="gotoAFQpage()">
                                               Ask a Free Question
                                            </div>
                                        </div>
                    ...
                    <li data-slider-anima="fade-left" data-time="1000">
                        <div class="section-slide">
                            <div class="bg-cover"
                                 style="background-image:url({!! asset('assets/images/slide2.jpg') !!})"></div>
                            <div class="container">
                                <div class="container-middle">
                                    <div class="container-inner text-center">
                                        <div class="row">
                                            <div class="col-md-12 anima">
                                                <h2 class="text-white">Get Advice From Top Lawyers
                                                    <span> CAs & CS</span></h2>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li data-slider-anima="fade-left" data-time="1000">
                        <div class="section-slide">
                            <div class="bg-cover"
                                 style="background-image:url({!! asset('assets/images/slide3.jpg') !!})"></div>
                            <div class="container">
                                <div class="container-middle">
                                    <div class="container-inner text-center">
                                        <div class="row">
                                            <div class="col-md-12 anima">
                                                <h2 class="text-white">Get answers from the
                                                    and<span> Our best experts</span></h2>
                                            </div>
                                        </div>
                                        <hr class="space visible-sm"/>
                                    </div>
    ...
    <div class="section-empty" style="margin-top:0px; top:-40px;">
        <div class="container content pt_0">
            ...
            <p class="text-center mb50">Consult our most experienced lawyers practicing in more than 700 districts
                across the country.</p>
            <div class="row">
                @foreach ($topLawyers as $item)

                    <div class="col-md-3 col-sm-6">
                        <div class="advs-box niche-box-team" data-anima="scale-up" data-trigger="hover"><a
                                    href="{{ url('advocate-profile/'.$item->url_slug) }}" class="img-box">
                                <img class="anima" style="height: 250px; width: 250px;"
                                     src="{{asset('uploads/profile/'.$item->profile_image)}}"
                                     onerror="this.onerror=null;this.src='images/lawyer.jpg'"
                            ...
                            <div class="content-box">
                                ...
                                @endif
                                <p>{{ (strlen($item->about_me) > 100)? substr($item->about_me,0,100).'...': $item->about_me}}
                                    <a href="{{ url('advocate-profile/'.$item->url_slug) }}"> Read More</a></p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="tab-box" data-tab-anima="fade-left">
                <div class="panel active">
                    <div class="flexslider carousel outer-navs"
                         data-options="minWidth:250,itemMargin:30,controlNav:false">
                        <ul class="slides">
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    <div class="price">INR 25000/-</div>
                                    <a href="{{ url('legal-services/mutual-consent-divorce') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service1.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                        <h2>Mutual Consent Divorce</h2>
                                        <p>File for divorce & get a divorce decree in just 1-8 months.</p>
                                    </div>
                                    <div class="viewmore"><a href="{{ url('legal-services/mutual-consent-divorce') }}">View
                            ...
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    ...
                                    <a href="{{ url('legal-services/company-hr-documentation') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service2.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                    ...
                                    <div class="viewmore"><a
                                                href="{{ url('legal-services/company-hr-documentation') }}">View More <i
                            ...
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    ...
                                    <a href="{{ url('legal-services/complaint-under-rera') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service3.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                        <h2>Complaint Under RERA </h2>
                                        <p>File a complaint against your builder under RERA. </p>
                                    </div>
                                    <div class="viewmore"><a href="{{ url('legal-services/complaint-under-rera') }}">View
                                            More <i class="fa fa-chevron-right"></i></a></div>
                                </div>
                            </li>
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    ...
                                    <a href="{{ url('legal-services/marriage-registration') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service4.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                        <h2>Marriage Registration </h2>
                                        <p>Get your marriage registered and get a Marriage Certificate. </p>
                                    </div>
                                    <div class="viewmore"><a href="{{ url('legal-services/marriage-registration') }}">View
                                            More <i class="fa fa-chevron-right"></i></a></div>
                                </div>
                            </li>
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    ...
                                    <a href="{{ url('legal-services/website-policy-and-terms') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service5.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                    ...
                                    <div class="viewmore"><a
                                                href="{{ url('legal-services/website-policy-and-terms') }}">View More <i
                                                    class="fa fa-chevron-right"></i></a></div>
                                </div>
                            </li>
                            <li>
                                <div class="img-box adv-img adv-img-half-content text-left">
                                    ...
                                    <a href="{{ url('legal-services/cheque-bounce-notice') }}"
                                       class="img-box img-scale-up"> <img src="/assets/images/legal_service6.jpg"
                                                                          alt=""/> </a>
                                    <div class="caption">
                                        <h2>Cheque Bounce Notice </h2>
                                        <p>Send a legal notice to the issuer for a cheque bounce matter. </p>
                                    </div>
                                    <div class="viewmore"><a href="{{ url('legal-services/cheque-bounce-notice') }}">View
                                            More <i class="fa fa-chevron-right"></i></a></div>
                                </div>
                            </li>
                        </ul>
        ...
        <div class="container ">
            <div class="row proporzional-row">
                <div class="col-md-3 boxed text-center white">
                    ...
                    <p>We are one of the cardinal Company Registration consultants of India and we have our roots in
                        each and every part of India. We give professional assistance in the legal, financial and
                        advisory terms transforming your issues to in easy and affordable legal services.</p>
                </div>
                <div class="col-md-9 col-sm-12"><a class="img-box inner img-bubble" href="#"> <span><img
                                    src="/assets/images/image-2.png" class="img-responsive" alt=""/></span> <span
                                class="caption-box" data-anima="show-scale"> <span class="caption">We believe in giving you the best solutions and help you effectively in any of your requirements.</span> </span>
                    </a></div>
            </div>
        </div>
    </div>
        ...
        <div class="container content">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="advs-box advs-box-top-icon-img boxed-inverse text-left"><a
                                class="img-box lightbox img-scale-up"
                                href="{{ url('corporate/company-registration') }}"> <span><img
                                        src="/assets/images/service1.jpg" alt=""></span> </a>
                        <div class="advs-box-content">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="advs-box advs-box-top-icon-img boxed-inverse text-left"><a
                                class="img-box lightbox img-scale-up" href="{{ url('corporate/one-person-company') }}">
                            <span><img src="/assets/images/service2.jpg" alt=""></span> </a>
                        <div class="advs-box-content">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="advs-box advs-box-top-icon-img boxed-inverse text-left"><a
                                class="img-box lightbox img-scale-up" href="{{ url('corporate/gst-return-filing') }}">
                            <span><img src="/assets/images/service3.jpg" alt=""></span> </a>
                        <div class="advs-box-content">
                ...
                <div class="col-lg-3 col-sm-6 col-xs-12">
                    <div class="advs-box advs-box-top-icon-img boxed-inverse text-left"><a
                                class="img-box lightbox img-scale-up" href="{{ url('corporate/one-person-company') }}">
                            <span><img src="/assets/images/service4.jpg" alt=""></span> </a>
                        <div class="advs-box-content">
    ...
    <div class="section-bg-color no-paddings-y pt40 testimonial_bg">
        <div class="container content">
            ...
            <div class="row vertical-row">
                <div class="col-md-6">
                    <div class="flexslider slider nav-inner nav-right"
                         data-options="controlNav:true,directionNav:false">
                        <ul class="slides">
                            <li>
                                <div class="advs-box niche-box-testimonails-cloud">
                                    <p><i class="fa fa-quote-left"></i> This is the right place you should hop in if you
                                        are planning to have company incorporation. The service I got from Kanoonvala
                                        was extremely efficient. They have accomplished the work as per commitment. <i
                                                class="fa fa-quote-right"></i></p>
                                    <div class="name-box"><i class="fa text-l circle onlycover"><img
                                                    src="/assets/images/client1.jpg" class="img-responsive"></i>
                            ...
                            <li>
                                <div class="advs-box niche-box-testimonails-cloud">
                                    <p><i class="fa fa-quote-left"></i> I wanted a place where I would be guided about
                                        the clearance of the legalities as I wanted to start a plant. Kanoonvala made
                                        everything very easy and delivered their work to us on time. <i
                                                class="fa fa-quote-right"></i></p>
                                    <div class="name-box"><i class="fa text-l circle onlycover"><img
                                                    src="/assets/images/client2.jpg" class="img-responsive"></i>
                            ...
                            <li>
                                <div class="advs-box niche-box-testimonails-cloud">
                                    <p><i class="fa fa-quote-left"></i> There I want to share my experience with you
                                        regarding the services Kanoonvala provided and I am really thankful to them. I
                                        am from Canada and the dream project I wanted to start in India had to go
                                        through some legal issues. <i class="fa fa-quote-right"></i></p>
                                    <div class="name-box"><i class="fa text-l circle onlycover"><img
                                                    src="/assets/images/client3.jpg" class="img-responsive"></i>
                ...
                <div class="col-md-6 text-right" data-anima="fade-right"><img src="/assets/images/avatar-3.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="flexslider carousel outer-navs png-boxed png-over text-center"
                        ...
                        <ul class="slides">
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_1.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_2.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_3.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_4.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_5.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_6.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_7.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_8.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_1.png" alt=""> </a>
                            </li>
                            <li><a class="img-box" href="#"> <img src="/assets/images/logos/logo_2.png" alt=""> </a>
...
@endsection
<script>
    function gotoAFQpage(){
        window.location="{{ url('free-advice/free-question') }}";
    }
</script>