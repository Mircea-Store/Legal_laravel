    ...
    <tr>
        <td align="left" style="color: #888888; width:20px; font-size: 16px; line-height: 24px;">
            ...
            <table align="left" style="color: #888888; width:100%; line-height: 24px;">
                ...
                <tr>
                    <td style="font-size:17px; color:#fff; margin:10px; 0">Mobile</td>
                    <td style="font-size:17px; color:#fff; margin:10px; 0">{{$mobile}}</td>
                </tr>
                <tr>
                    <td style="font-size:17px; color:#fff; margin:10px; 0">Enquiry for</td>
                    <td style="font-size:17px; color:#fff; margin:10px; 0">{{$reason_for}}</td>
                </tr>
                <tr>
